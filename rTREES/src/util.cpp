...
// int lines(const String &filename)//rTREES will break
// {
//         int i = 0; //counter
//         ifstream in;
//
...
// int datalines(const String &filename)//rTREES will break
// {
//         int i = 0; //counter
//         ifstream in;
//
...
///rTREES I think all the following are vestigial.
// //ascending
